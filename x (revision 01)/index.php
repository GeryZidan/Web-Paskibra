	...
	<div class="isi">
			...
			<div class="col-md-3">
				<div class="card" style="width: 16rem;">
				  ...
				  <div class="card-body">
				    ...
				    <p class="card-text">lorem lo rem lo ram lo emilia ane subaru lorem lo rem lo ram lo emilia ane subaru lorem lo rem lo ram lo emilia ane subaru lorem lo rem lo ram lo emilia.</p>
				  </div>
				</div><br>
			</div>
			<div class="col-md-3">
		...
		<div class="row" style="width: 100%;margin-top: 30px">
			<div class="col-md-6" style="padding: 20px 7px 20px 20px">
				<div style="position: absolute;height: 35px;width: 8px;background-color: #ea2738;"></div><h2 style="margin-left: 30px"> PASKIBRA</h2>
				...
				Anggotanya berasal dari pelajar SMA Sederajat kelas 1 atau 2. Penyeleksian anggotanya biasanya dilakukan sekitar bulan April untuk persiapan pengibaran pada 17 Agustus.<br><br>
				Selama waktu seleksi sampai 16 Agustus, seorang anggota calon Paskibraka dinamakan "CAPASKA" atau Calon Paskibraka. Pada waktu penugasan 17 Agustus, anggota dinamakan "PASKIBRAKA", dan setelah 17 Agustus, dinamakan "PURNA PASKIBRAKA".<br><br>
				Tingkatan Paskibraka ada tiga yaitu:<br>
				Paskibraka Nasional - bertugas di Istana Merdeka<br>
				Paskibraka Propinsi - bertugas di Pusat pemerintahan gubernur propinsi<br>
